...
exports.getImageFieldsFromRequest = function(req) {
  var allImages = [];
  console.log(req.files);
  req.files.forEach( function(field) {
    var images = req.files[field][0];
    images.field = req.files[field];
    allImage.push(images);
  });
